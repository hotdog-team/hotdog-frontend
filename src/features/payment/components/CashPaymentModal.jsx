...
import { Button, ModalShell } from '../../../components/index.js'
...
export default function CashPaymentModal({
  ...
  return (
    <ModalShell title="무통장 입금 안내" onClose={onClose} maxWidth="max-w-md">
      <div className="space-y-5">
        <div className="rounded-md border border-border bg-surface-muted p-4">
          ...
          <div className="mt-3 flex items-center justify-between gap-3">
            <div>
              <p className="text-body-sm text-muted">{bankName}</p>
              <p className="mt-1 text-lg font-bold text-ink">{accountNumber}</p>
            </div>
        ...
        <div className="space-y-2 text-body-sm">
          ...
          <div className="flex justify-between">
            ...
            <strong className="text-brand">{totalAmount.toLocaleString()}원</strong>
          </div>
        </div>
